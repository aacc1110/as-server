export const createAuthEmail = (registered: string, code: string) => {
  ...
  <div style="text-align: center; margin-top: 1rem; color: #868e96; font-size: 0.85rem;"><div>위 버튼을 클릭하시거나, 다음 링크를 열으세요: <br/> <a style="color: #b197fc;" href="${FRONT_HOST}/${
    keywords.type
  }?code=${code}">${FRONT_HOST}/${
    keywords.type
